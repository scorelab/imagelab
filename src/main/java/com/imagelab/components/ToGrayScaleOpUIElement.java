...
/**
 * Class which builds the covert gray scale operation
 * related UI element
 */
public class ToGrayScaleOpUIElement extends OperatorUIElement<Button> implements Draggable, Cloneable {
    public ToGrayScaleOpUIElement(OnUIElementCloneCreated onCloneCreated,
    ...
    public void dragDetected(MouseEvent event) {
        System.out.println("Drag detected: ToGrayScaleOpUIElement");
     ...
     * dragged UI element.
     *
     * @return - a cloned ToGrayScaleOpUIElement
     * @throws CloneNotSupportedException
     */
    public ToGrayScaleOpUIElement clone() throws CloneNotSupportedException {
        super.clone();
        return new ToGrayScaleOpUIElement(
                getOnCloneCreated(),
                getOnDragDone(),
                getStylingID(),
                false,
     ...
     * @return - Built ToGrayScaleOpUIElement
     */
    @Override
