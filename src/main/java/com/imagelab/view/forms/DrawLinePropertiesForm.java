...
public class DrawLinePropertiesForm extends AbstractPropertiesForm {
	public DrawLinePropertiesForm(DrawLine operator) {
		// title container
	    PropertiesFormTitleContainer DrawLineTitleContainer;
	    DrawLineTitleContainer = new PropertiesFormTitleContainer("Draw Line Properties");
	    ...
	    x2PointSlider.valueProperty().addListener(new ChangeListener<Number>() {
			...
			public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
				// TODO Auto-generated method stub
				lblX2Point.setText(String.format("Point X1 : %.2f units", newValue.doubleValue()));
	    ...
	    Label lblY2Point = new Label("Point: Y1");
	    ...
	    y2PointSlider.valueProperty().addListener(new ChangeListener<Number>() {
			...
			public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
				// TODO Auto-generated method stub
				lblY2Point.setText(String.format("Point Y1 : %.2f units", newValue.doubleValue()));
	    ...
	    VBox drawLineContainer = new VBox();
	    drawLineContainer.setPrefSize(205, 47);
	    drawLineContainer.setSpacing(20);
	    drawLineContainer.setLayoutX(14);
	    drawLineContainer.setLayoutY(14);
	    drawLineContainer.getChildren().addAll(
	    ...
	    getChildren().addAll(drawLineContainer);
