...
public class DrawRectangle extends OpenCVOperator {
     ...
     * pointX value for the openCV point.
     */
    private double pointX2 = 300d;
    /**
     * pointY value of the openCV point.
     */
    private double pointY2 = 280d;
	/**
	...
	public Mat compute(Mat image) {
		...
		return drawRectangle(image,getPointX1(),getPointY1(),getPointX2(),getPointY2(),
				getR(),getG(),getB(), getThickness());
	}

	private Mat drawRectangle(Mat src,double pointX1,double pointY1,double pointX2,double pointY2,
        ...
        // Applying Rectangle Imageproc
        Imgproc.rectangle(src,point1,point2,scalar,thickness);
