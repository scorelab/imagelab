...
public class DrawArrowLinePropertiesForm extends AbstractPropertiesForm {
	public DrawArrowLinePropertiesForm(DrawArrowLine operator) {
		// title container
	    ...
	    Label lblSpaceOne = new Label("Color Properties");
	    ...
	    VBox drawArrowLineContainer = new VBox();
	    drawArrowLineContainer.setPrefSize(205, 47);
	    drawArrowLineContainer.setSpacing(20);
	    drawArrowLineContainer.setLayoutX(14);
	    drawArrowLineContainer.setLayoutY(14);
	    drawArrowLineContainer.getChildren().addAll(
	    		RedSliderContainer,
	    ...
	    getChildren().addAll(drawArrowLineContainer);
